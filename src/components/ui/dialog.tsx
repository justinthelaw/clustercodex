  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed left-1/2 top-1/2 z-50 grid w-[95vw] max-w-4xl -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl border border-border/70 bg-card p-5 shadow-2xl sm:p-6",
          className
        )}
        {...props}
      >
